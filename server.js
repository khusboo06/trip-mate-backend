...
// /* ---------------------- CORS SETUP ---------------------- */
// const allowedOrigins = ["http://localhost:5173", "http://localhost:5174","https://trip-mate-frontend-nine.vercel.app"];
// app.use(cors({
...
// //   "http://localhost:5173",
// //   "http://localhost:5174",
// //   "https://trip-mate-frontend-nine.vercel.app" // ✅ your production frontend
// // ];
...
/* ------------------------------------------------------
   ✅ CORRECT CORS SETUP (Fixes login + OTP + all requests)
------------------------------------------------------- */
const allowedOrigins = [
  "http://localhost:5173",
  "http://localhost:5174",
  "https://trip-mate-frontend-nine.vercel.app"
];
...
/* ------------------------------------------------------
   Body parser (must be ABOVE routes)
------------------------------------------------------- */
app.use(express.json());
